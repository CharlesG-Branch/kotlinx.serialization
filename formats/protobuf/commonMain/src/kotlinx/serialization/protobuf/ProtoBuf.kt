 ...
 * encoding. This behaviour can be changed via [ProtoIntegerType] annotation.
 *
...
@Deprecated(
    "Empty constructor was deprecated in the favor of Default instance function during serialization 1.0 API stabilization",
    level = DeprecationLevel.ERROR,
